...
```{r write_FamiliesAndOrders, include=FALSE}
taxonomy_of_orders_df <- taxonomy_of_families_df[!duplicated(taxonomy_of_families_df$order),1:6]
write.csv(taxonomy_of_families_df, "Eukaryota_families_2023-09-19.csv", row.names = F)
write.csv(taxonomy_of_orders_df, "Eukaryota_orders_2023-09-19.csv", row.names = F)
```
