...
output_folder <- "Maine_12S_all_2024-11-18" #name of your output folder every time
...
# use taxizedb to get a list of all ncbi species for each missing clade (skipped #12 Microlaimida_2987755, 17 Plectia_2976037, 58 Tylenchida_2784607, 97, 107, 108, 142, 169, 171, 196, 206, 222, 225, 276, 292, 300, 342, 357, 397)
c=1
...
a01_NAMES$n_target <- as.numeric(a01_NAMES$n_target)
```

## Scrape accessions identified above from GenBank.
```{r scrape_accessions}
# skipped 101 Achnanthidium minutissimum (weird formatting); 264 ; 1661, 1713, 1859, 2304, 2705, 3286, 3656, 3968, 4079, 4086, 4162, 4250, 4460, 4722, 4723, 4763, 4856, 4879, 5145, 5228, 5401, 5627, 5993, 6405, 7219, 7308, 7309, 7328, 7329, 7662, 8166, 8287, 8290, 8289, 8297, 8302, 8329, 8355, 8387, 9386, 9452, 9461, 9730, 9893, 10495, 10572, 11051, 11375, 11444, 12565, 12569, 12570, 13097, 13276, 13307, 13314, 13887, 14320, 14373, 14454, 15135, 15275, 15288, 16184, 16520, 16586, 16589, 16708, 16818, 17007, 17176, 17380, 17471, 17511, 17567, 17856, 18049, 18130, 18142, 18303, 18314, 18316, 18320, 18441,18449, 18460, 18479, 18539, 18577, 18582, 18604, 18807, 18843, 18851, 18963, 18978, 19177, 19287, 19347
s=s+1 
while (s <= dim(a01_NAMES)[1]){ #for every good species name
    ...
    if (a01_NAMES$n_target[s]>0 && a01_NAMES$n_target[s]<100) { # scrape GenBank target sequences if available, but skip if >= 100 targets
     ids <- c(unlist(strsplit(a01_NAMES$ids_target[s], split="\\|")))
      } else if  (a01_NAMES$n_target[s]>100) {   # if more than 100 accessions, randomly select 100  
...
# COI skipped row 119, 230, 462, 470, 496, 565, 574, 616, 661, 675, 676, 951, 1061, 1302, 1354, 1355, 1410, 1413, 1453, 1605, 1623, 1725, 1972, 2081, 2092, 2125, 2126, 2181, 2221, 2304, 2369, 2399, 2400, 2401, 2402, 2403, 2532, 2536, 2763, 2764, 2765, 2766, 2767, 2768, 2775, 2486, 2848, 2867, 2872, 3382, 3420, 3499, 3542, 3692, 3796, 3848, 3877, 3888, 3902, 3913, 3921, 3927, 3930, 3942, 3944, 3948, 3951, 3952, 3954, 3956, 3960, 3993, 3995, 4158, 4196, 4329, 4367, 4378, 4734, 4765, 4792, 4793, 4809, 4924, 4939, 5044, 5123, 5135, 5286, 5460, 5594, 5668, 5852, 6271, 6288, 6289, 6290, 6291, 6292, 6389, 6453, 6458, 6689, 6872, 6874, 7061, 7062, 7063, 7178, 7346, 7485, 7579, 7679, 7748, 7753, 7760, 7761, 8064, 8083, 8147, 8302, 8391, 8418, 8470, 8571, 8694, 8740, 8798, 8799, 8836, 8868, 8875, 8876, 9276, 9311, 9312, 9548, 9663, 9648, 9691, 9760, 9781, 9870, 9893, 10122, 10125, 10152, 10201, 10229, 10230, 10547, 10659, 10660, 10667, 10770, 10836, 10837, 10849, 11154, 11394, 11415, 11457, 11575, 11711, 11799, 12131, 12149, 12498, 12499, 12500, 12502, 12507, 12508, 12509, 12510, 12511, 12512, 12514, 12515, 12517, 12518, 12656, 12765, 12853, 12943, 13110, 13122, 13123, 13132, 13225, 13363, 13491, 13713, 13736, 13740, 13746, 13754, 13767, 13768, 13679, 13996, 13998, 14002, 14004, 14231, 14322, 14360, 14370, 14451, 14484, 14538, 14586, 14629, 14642, 14670, 14737, 14741, 14748, 14777, 14796, 14829, 14939, 15007, 15012, 15121, 15383, 15442, 15566, 15590, 15663, 15672, 15743, 15752, 15869, 15966, 16001, 16039, 16292, 16666, 16772, 16776, 16966, 17090, 17174, 17206, 17255, 17262, 17279, 17319, 17435, 17451, 17453, 17455, 17457, 17461, 17463, 17464, 17465, 17690, 17735, 17761, 18049, 18089, 18098, 18158, 18239, 18241, 18242, 18326, 18327, 18328, 18365, 18456, 18498, 18547, 18580, 18644, 18681, 18715, 18837, 18838, 18840, 18841, 18902, 18903, 18989, 18990, 18993
# 12S skipped 230, 461, 462, 470, 496, 565, 574, 626, 661, 675, 676, 951, 1061, 1093, 1302, 1354, 1355, 1410, 1413, 1453, 1537, 1538, 1605, 1623, 1725, 1972, 2081, 2181 2092,2126 2125, 2221, 2304, 2396, 2399, 2400, 2401, 2402, 2403, 2518, 2532, 2536, 2763, 2764, 2765, 2766, 2767, 2768, 2781, 2846, 2848, 2867, 2872, 3382, 3420, 3499, 3542, 3692, 3796, 3877, 3888, 3902, 3913, 3921, 3927, 3930, 3942, 3944, 3948, 3951, 3952, 3954, 3956, 3960, 3995, 4144, 4196, 4329, 4367, 4378, 4764, 4765, 4792, 4793, 4809, 4924, 5044, 5123, 5135, 5286, 5460, 5668, 5852, 6266, 6271, 6389, 6453, 6458, 6689, 6872, 6874, 6875, 7061, 7062, 7063, 7178, 7299, 7346, 7485, 7579, 7679, 7748, 7753, 7760, 7761, 8064, 8083, 8147, 8302, 8391, 8418, 8443, 8470, 8571, , 106678626, 8694, 8740, 8798, 8799, 8836, 8868, 8875, 8876, 9276, 9548, 9663, 9684, 9691, 9760, 9781, 9893, 10122, 10125, 10152,10201, 10229, 10230, 10547, 10659, 10660, 10837, 11154, 11394, 11415, 11420, 11452, 11457, 11575, 11711, 12131, 12149, 12446, 12498, 12499, 12500, 12502, 12507, 12508, 12509, 12510, 12511, 12512, 12514, 12515, 12516,12517, 12518, 12580, 12656, 12765, 12853, 12943, 13122, 13132, 13255, 13363, 13491, 13666, 13713, 13736, 13740, 13746, 13574, 13768, 13769, 13996, 13998, 14001, 14004, 14231, 14322, 14360, 14370, 14451, 14484, 14583, 14623, 14629, 14642, 14670, 14737, 14741, 14748, 14777, 14796, 14829, 14939, 15007, 15012, 15121, 15168, 15383, 15566, 15590, 15663, 15680, 15686, 15743, 15752, 15869, 15966, 16001, 16039, 16292, 16666, 16772, 16776, 17090, 17174, 17206, 17255, 17262, 17279, 17319, 17435, 17451, 17453, 17455, 17457, 17461, 17463, 17464, 17465, 17534, 17558, 17690, 17735, 17761, 17809, 18049, 18089, 18098, 18189, 18208, 18223, 18295, 18297, 18302, 18329, 18330, 18331, 18344, 18365, 18366, 18376, 18436, 18472, 18605, (might be missing some) 19096, 19103, 19154, 19190, 19254, 19263, 19318, 19320, 19352, 19396, 19463, 19489, 19490
# 18520, 18472, 18436, 18376, 18331 try again (ERROR 400)
...
short_seqs <- which(nchar(REFDB_dada$sequence) <=65)
long_seqs <- which(nchar(REFDB_dada$sequence) >=1500)
good_seqs <- which(nchar(REFDB_dada$sequence) >65 & nchar(REFDB_dada$sequence) <1500)

REFDB_dada <- REFDB_dada[good_seqs,]

write.table(REFDB_dada, file.path(output_folder, "REFDBdada_12SEukaryotes_MaineeDNA.fasta"), sep="\n", col.names=FALSE, row.names=FALSE, quote=FALSE)
```
